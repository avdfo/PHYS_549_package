...
class simulation:
    ...
    def ARPES_cube(self, ARPES_dict=None, slice_select=None, add_map=False, plot_bands=False, ax=None, colourmap=None, noise=False, NSR=0.1):
        ...
        if slice_select != None:
            ax_img = self.AE.plot_intensity_map(Ig, slice_select, plot_bands, ax, colourmap=colourmap)

        if add_map:
            self.AE.maps.append(
                imap.intensity_map(len(self.AE.maps), Ig, self.AE.cube, self.AE.kz, self.AE.T, self.AE.hv, self.AE.pol, self.AE.dE, self.AE.dk,
                                    self.AE.SE_args, self.AE.sarpes, self.AE.ang))
        else:
            self.AE.maps = [
                imap.intensity_map(len(self.AE.maps), Ig, self.AE.cube, self.AE.kz, self.AE.T, self.AE.hv, self.AE.pol, self.AE.dE, self.AE.dk,
    ...
    def extract2D(self, datacube, slice_select):
